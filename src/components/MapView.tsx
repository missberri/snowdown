...
const venueCoordinates: Record<string, { lat: number; lng: number }> = {
  ...
  "Durango American Legion - 878 E 2nd Ave": { lat: 37.28396793498207, lng: -107.87369191936536 },
  ...
  "Powerhouse Science Center - 1333 Camino Del Rio": { lat: 37.278873388825346, lng: -107.88002176169506 },
  "Ska World Headquarters. - 225 Girard Street": { lat: 37.23899936652057, lng: -107.87608964635618 },
  "Ska Brewing - 225 Girard": { lat: 37.23899936652057, lng: -107.87608964635618 },
  ...
  "The Powerhouse - 1333 Camino Del Rio": { lat: 37.279098272652504, lng: -107.88005590580784 },
